...
// Type for icon components (Lucide icons)
...
// 🔁 Center flower image – make sure this file exists in /public
const measuringTapeFlower = "./faviconLogo.png";
    ...
    <div className="flex items-center justify-center min-h-screen">
      <div className="relative w-[1000px] h-[900px] -ml-[890px]">
        ...
        >
          ...
          {/* Center circle */}
          <circle cx="300" cy="300" r="60" fill="url(#centerGradient)" />
