...
const sanitizeText = (value?: string | null): string => {
  if (!value) return ""; // handles null/undefined/empty

  const trimmed = value.trim();
  if (!trimmed) return "";

  // Avoid literal 'NULL' in any case form
...
export function ServicesPage() {
  ...
  const integrations = [
    ...
    },
    {
      ...
      desc: "Unified Maharashtra government portal integration for citizen-centric municipal services.",
    },
    {
      icon: Workflow,
      title: "Payment Gateways",
      desc: "Secure integration with multiple payment gateways for online tax and fee collection.",
    },
    {
      icon: Shield,
      title: "Digital Signature",
      desc: "Support for digital signatures to ensure authenticity and non-repudiation of municipal documents.",
    },
    {
      icon: Network,
      title: "Citizen Portal",
      desc: "Self-service citizen portal integration for viewing dues, payments, and service requests online.",
    },
    {
      icon: Workflow,
      title: "Chatbots",
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative pt-20 h-[60vh] sm:h-[65vh] md:h-[70vh] min-h-[500px] sm:min-h-[550px] md:min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          >
            ...
            >
              Comprehensive digital solutions for modern urban development and
              municipal excellence across Maharashtra
            </motion.p>
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="absolute inset-0">
                <ImageWithFallback
                  src={service.image}
                  alt={sanitizeText(service.title)}
                  className="w-full h-full object-cover"
                />
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {benefits.map((benefit, index) => (
                ...
                >
                  ...
                  >
                    {sanitizeText(benefit.title)}
                  </h3>
                  <p className="text-gray-600">
                    {sanitizeText(benefit.desc)}
                  </p>
                </motion.div>
              ))}
            </div>
        ...
        {/* Technology Stack and Seamless Integration */}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
                {integrations.map((integration, index) => (
                  ...
                  >
                    ...
                    >
                      {sanitizeText(integration.title)}
                    </span>
                  </motion.div>
                ))}
              </div>
            ...
            >
              ...
              <div className="absolute inset-0">
                <ImageWithFallback
                  ...
                  alt={sanitizeText(services[selectedService].title)}
                  className="w-full h-full object-cover"
                />
              ...
              <div className="relative z-10 overflow-y-auto max-h-[85vh] p-8 md:p-12">
                ...
                >
                  ...
                  <h2
                    ...
                    style={{ fontWeight: 700 }}
                  >
                    {sanitizeText(services[selectedService].title)}
                  </h2>
                  <p className="text-xl text-white/90 max-w-2xl mx-auto leading-relaxed">
                    {sanitizeText(services[selectedService].desc)}
                  </p>
                </motion.div>
                ...
                >
                  <h3
                    className="text-2xl mb-6 text-white text-center"
                    style={{ fontWeight: 600 }}
                  >
                    Key Features
                  </h3>
