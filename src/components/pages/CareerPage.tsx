...
// import { Footer } from "@/components/layout/Footer"; // uncomment if you use it
...
const CULTURE_SLIDES: CultureSlide[] = [
  {
    id: 1,
  ...
  },
  {
    ...
    title: "#GrowthCulture",
    subtitle:
      "Empowering every team member to reach their full potential through",
  ...
  },
  {
    ...
    subtitle:
      "Building tomorrow's solutions for municipal governance through",
    hashtag: "#TechForGood",
    points: [
...
function CultureCarousel({
  ...
  const cardBackgrounds = [
    "linear-gradient(135deg, #FED7B0 0%, #F9C89B 100%)",
    "linear-gradient(135deg, #C8E6F5 0%, #A5D8F0 100%)",
    "linear-gradient(135deg, #E5D4F7 0%, #D4BBEF 100%)",
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-3xl mx-auto">
            Experience a workplace that values your well-being, growth, and
            contributions
          </p>
        </motion.div>
                    ...
                    <div className="p-6 sm:p-8 lg:p-12 flex flex-col justify-center order-2 lg:order-1">
                      ...
                      <div className="space-y-4 sm:space-y-5 mb-6 sm:mb-8">
                        {slide.points.map((point, idx) => (
                          <div
                            key={idx}
                            className="pb-3 sm:pb-4 border-b border-gray-400/40"
                          >
          ...
          {cultureSlides.map((_, idx) => (
            ...
            >
              <div
                ...
                style={{
                  backgroundColor:
                    idx === currentIndex ? colors.primary : "#D1D5DB",
                }}
              />
            </button>
          ))}
...
export function CareerPage() {
  ...
  const handleFormChange = (field: keyof CareerFormData, value: any) => {
    setFormData((prev) => ({
      ...prev,
      [field]: value,
    }));
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      let workExpString: string;
      if (hasWorkExperience && workExperiences.length > 0) {
        workExpString = workExperiences
          .map((exp, index) => {
            const currentWorkingText = exp.currentlyWorking
              ? " (Currently Working)"
              : "";
...
Period: ${exp.startDate} to ${endDateText}${currentWorkingText}`;
      ...
      const response = await fetch(
        "https://sthapatyabackend.tabamc.in/api/career/apply",
        {
          method: "POST",
          body: formDataToSend,
        }
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative pt-20 h-[60vh] sm:h-[65vh] md:h-[70vh] min-h-[500px] sm:min-h-[550px] md:min-h-[600px] overflow-hidden">
        ...
        <div className="relative z-10 h-full flex items-center justify-center px-4 sm:px-6 md:px-8">
          ...
          >
            ...
            >
              Join 800+ professionals making a real impact on municipal
              governance across Maharashtra
            </motion.p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-10">
          ...
          <div className="flex flex-wrap gap-2 sm:gap-3 justify-center">
            {categories.map((category) => (
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className={`px-4 sm:px-6 py-2 sm:py-2.5 rounded-full transition-all text-xs sm:text-sm ${
        ...
        <div
          id="open-positions"
          className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-6 sm:mb-8 lg:mb-12"
        >
          {/* Sidebar */}
          <motion.div
          ...
          >
            <div className="lg:sticky lg:top-24">
              <div className="mb-3 sm:mb-4">
                <div
                  className="w-12 sm:w-16 h-1 mb-2 sm:mb-3 lg:mb-4 rounded-full"
                ...
                <p className="text-xs sm:text-sm text-gray-500 mt-1 sm:mt-2">
                  ...
                  {selectedCategory !== "All" ? selectedCategory : ""} positions
                </p>
              </div>
              ...
              <div className="space-y-2 max-h-[300px] sm:max-h-[350px] lg:max-h-[450px] overflow-y-auto pr-1 sm:pr-2 custom-scrollbar">
                {visiblePositions.map((position) => (
                  <motion.button
                    ...
                    whileHover={{ x: 5 }}
                    className={`w-full text-left p-2.5 sm:p-3 lg:p-4 rounded-lg sm:rounded-xl border-2 transition-all ${
                  ...
                  >
                    <div className="flex items-start gap-2 sm:gap-2.5 lg:gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p
                          className={`text-[10px] sm:text-xs lg:text-sm truncate ${
                            selectedPosition.id === position.id
                              ? "text-white/80"
                              : "text-gray-500"
                          }`}
          ...
          >
            <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-5 lg:p-6 xl:p-8 border-2 border-gray-200 shadow-lg">
              ...
              <div className="mb-4 sm:mb-6 lg:mb-8">
                <div className="flex flex-col sm:flex-row items-start gap-2.5 sm:gap-3 lg:gap-4 mb-3 sm:mb-4 lg:mb-6">
                  ...
                  <div className="flex-1">
                    <h2
                      className="text-lg sm:text-xl lg:text-2xl xl:text-3xl mb-1 sm:mb-1.5 lg:mb-2"
                      style={{ fontWeight: 700, color: colors.text }}
                    >
                ...
                <div className="flex flex-wrap gap-1.5 sm:gap-2 lg:gap-3">
                  <div className="flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3 lg:px-4 py-1 sm:py-1.5 lg:py-2 bg-gray-50 rounded-full">
                    <MapPin
                      size={12}
                      className="sm:w-3.5 sm:h-3.5 lg:w-4 lg:h-4 flex-shrink-0"
                      style={{ color: colors.accent }}
                    />
              ...
              <div className="mb-4 sm:mb-6 lg:mb-8">
                <h3
                  className="text-base sm:text-lg lg:text-xl mb-2 sm:mb-3 lg:mb-4"
                  style={{ fontWeight: 600, color: colors.text }}
                >
                  About This Role
                </h3>
                <p className="text-xs sm:text-sm lg:text-base text-gray-600 leading-relaxed">
                  We are looking for a talented {selectedPosition.title} to join
                  our {selectedPosition.department} team. This role offers an
                  exciting opportunity to work on large-scale municipal projects
                  across Maharashtra and contribute to transforming urban
                  governance.
                </p>
              </div>
                  ...
                  {selectedPosition.responsibilities.map(
                    (responsibility, index) => (
                      ...
                      >
                        <Target
                          size={12}
                          className="sm:w-3.5 sm:h-3.5 lg:w-4 lg:h-4 flex-shrink-0 mt-0.5 sm:mt-1"
                          style={{ color: colors.accent }}
                        />
                        <span className="text-[10px] sm:text-xs lg:text-sm text-gray-700">
                          {responsibility}
        ...
        >
          <div className="max-w-5xl mx-auto">
            <h2
              className="text-lg sm:text-xl lg:text-2xl text-center mb-4 sm:mb-6"
              style={{ fontWeight: 700, color: colors.text }}
            >
              Why Work With Us
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4 lg:gap-5">
              {BENEFITS.map((benefit, index) => (
                ...
                >
                  ...
                  <h2
                    className="text-xl sm:text-base mb-1.5 sm:mb-2"
                    style={{ fontWeight: 600, color: colors.text }}
                  >
                    {benefit.title}
                  </h2>
          ...
          >
              ...
              >
                ...
                {workExperiences.map((experience, index) => (
                  ...
                  >
                    ...
                    {/* Job Role */}
                    <div className="space-y-2">
                      <Label htmlFor={`jobRole-${experience.id}`}>
                        Job Role *
                      </Label>
                      <Input
                    ...
                    {/* Job Description */}
                    <div className="space-y-2">
                      <Label htmlFor={`jobDescription-${experience.id}`}>
                        Job Description *
                      </Label>
                      <Textarea
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                accept=".pdf,.doc,.docx"
                onChange={(e) =>
                  handleFormChange("resume", e.target.files?.[0] || null)
                }
              />
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleFormChange("noticePeriod", e.target.value)
                }
              />
              <p className="text-xs text-gray-500">
