...
export function JourneyPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative pt-24 sm:pt-20 h-auto sm:h-[65vh] md:h-[70vh] min-h-[550px] sm:min-h-[550px] md:min-h-[600px] overflow-hidden">
        ...
        <div className="relative z-10 h-full flex items-center justify-center px-4 sm:px-6 md:px-8">
          ...
          >
            ...
            >
              From a visionary start to becoming Maharashtra&apos;s leading
              urban governance partner — our journey of innovation, growth, and
                  ...
                  <div className="flex items-center gap-2 sm:gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p
                        ...
                        style={{ color: "#7D0A0A" }}
                      >
                        To become the most experienced company for Property tax
                        Survey and Assessment domain in India.
                      </p>
                    </div>
                    <motion.div
                      animate={{ rotate: 360 }}
        ...
        >
          ...
          <div className="relative z-10">
            <div className="text-center mb-4 sm:mb-6">
              <h2
                className="text-2xl sm:text-3xl md:text-4xl text-white mb-1.5 sm:mb-2"
              ...
              <p className="text-xs sm:text-sm text-white/80 max-w-2xl mx-auto px-2 sm:px-0">
                Continuing our mission to transform urban governance across
                India
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-5xl mx-auto px-4">
              ...
              <div className="space-y-4">
                {UPCOMING_ENHANCEMENTS.slice(0, 4).map((enhancement, index) => (
                  <motion.div
                    key={`enh-left-${index}`}
                  ...
                  >
                    ...
                    <p
                      className="text-sm sm:text-base lg:text-lg text-white/95 leading-relaxed"
              ...
              <div className="space-y-4">
                {UPCOMING_ENHANCEMENTS.slice(4, 8).map((enhancement, index) => (
                  <motion.div
                    key={`enh-right-${index}`}
                    initial={{ opacity: 0, x: 20 }}
                    whileInView={{ opacity: 1, x: 0 }}
      ...
      {/* Footer (if you want it here, uncomment and import) */}
      {/* <Footer /> */}
    </div>
  );
}
