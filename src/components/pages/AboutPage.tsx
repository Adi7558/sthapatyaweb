                        ...
                        <div className="space-y-4 text-gray-700 leading-relaxed">
                            ...
                            <div className="mt-6 p-6 bg-gray-50 rounded-xl border-2 border-gray-200">
                                <div className="flex items-center justify-between h-full">
                                    <img src="/image_data/AboutPage/1.avif" alt="Logo 1" className="h-20 w-20 object-contain" />
                                    <img src="/image_data/AboutPage/2.avif" alt="Logo 2" className="h-20 w-20 object-contain" />
                                    <img src="/image_data/AboutPage/3.avif" alt="Logo 3" className="h-20 w-20 object-contain" />
                                    <img src="/image_data/AboutPage/4.avif" alt="Logo 4" className="h-20 w-20 object-contain" />
                                </div>
                            </div>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="mt-6 flex justify-center gap-6">
                            ...
                            <div className="w-1/2 bg-gray-50 rounded-xl border-2 border-gray-200 p-6 flex justify-center items-center gap-6">
                                <img src="/image_data/AboutPage/5.avif" alt="Logo 5" className="h-20 w-20 object-contain" />
                                <img src="/image_data/AboutPage/6.avif" alt="Logo 6" className="h-20 w-20 object-contain" />
                            </div>

                            {/* Right card */}
                            <div className="w-1/2 bg-gray-50 rounded-xl border-2 border-gray-200 p-6 flex justify-center items-center gap-6">
                                <img src="/image_data/AboutPage/7.avif" alt="Logo 7" className="h-20 w-20 object-contain" />
                                <img src="/image_data/AboutPage/8.avif" alt="Logo 8" className="h-20 w-20 object-contain" />
                            </div>
                        </div>
