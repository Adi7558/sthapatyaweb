...
const IMPACT_METRICS: ImpactMetric[] = [
  {
    ...
    value: "12+ ",
    icon: Zap,
    desc: "CERT-In Certified Softwares",
  },
  {
    label: "Reliability",
    value: "25+ Years",
  ...
  },
  {
    ...
    value: "50L+ ",
    icon: TrendingUp,
    desc: "Massive project delivery",
  },
  {
    label: "Professionals",
    value: "800+",
    icon: CheckCircle,
    desc: "Trusted Employees",
  },
];
...
export function ProjectsPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section with Background Image - iPhone SE friendly */}
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
          ...
          >
            {heroStats.map((stat, index) => (
              ...
              >
                ...
                />
                <p
                  className="text-xl sm:text-2xl md:text-3xl mb-0.5 sm:mb-1"
      ...
      <div className="max-w-7xl w-full mx-auto px-3 sm:px-6 md:px-8 lg:px-12 py-6 sm:py-10 md:py-12 space-y-6 sm:space-y-10 md:space-y-12">
        ...
        >
          <div className="text-center mb-4 sm:mb-5">
            ...
            >
              Delivering measurable impact across Maharashtra&apos;s largest
        ...
        >
          <div className="relative z-10">
            <div className="text-center mb-4 sm:mb-5">
              <h2
                className="text-lg sm:text-xl md:text-2xl text-white mb-2"
                style={{ fontWeight: 700 }}
              >
                Measurable Impact
              </h2>
              <p className="text-white/90 text-xs sm:text-xs md:text-sm max-w-2xl mx-auto px-2 sm:px-0">
                Real results that transform urban governance and citizen
                services
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-5">
          ...
          >
            <div className="flex items-center gap-2 mb-2">
              <div
                className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg flex items-center justify-center shadow-md border-2"
                style={{
            ...
            <p
              className="text-xs sm:text-sm mb-2.5 sm:mb-3 leading-relaxed"
              style={{ color: colors.primary }}
            >
          ...
          >
            <div className="relative z-10 flex flex-col justify-center h-full">
              ...
              <h2
                className="text-sm sm:text-base md:text-lg text-white mb-2"
                style={{ fontWeight: 700 }}
              >
                Join 100+ ULBs Transforming Urban India
              </h2>
              <p className="text-white/90 text-xs sm:text-sm mb-3 sm:mb-4 leading-relaxed">
                Partner with Maharashtra&apos;s leading urban governance
                solutions provider. Let&apos;s build smarter cities together
                with cutting-edge GIS technology, smooth transactions with
                AI-powered softwares and step into the new virtual world.
              </p>
